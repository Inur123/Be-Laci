...
-- AddForeignKey
ALTER TABLE "Kegiatan" ADD CONSTRAINT "Kegiatan_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id");

-- AddForeignKey
ALTER TABLE "Kegiatan" ADD CONSTRAINT "Kegiatan_periodeId_fkey" FOREIGN KEY ("periodeId") REFERENCES "Periode"("id");
